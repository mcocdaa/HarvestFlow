...
> 本地化 AI Agent 会话数据采集、自动评分、人工复核与微调格式导出系统（采集 → 自动评分 → 人工复核 → 导出训练格式）。
...
[![Release](https://img.shields.io/github/v/release/mcocdaa/HarvestFlow?display_name=tag&sort=semver)](https://github.com/mcocdaa/HarvestFlow/releases)
