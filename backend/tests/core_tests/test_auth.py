...
class TestRequireApiKey:
    ...
    @pytest.mark.asyncio
    async def test_auth_disabled_when_key_empty(self, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_auth_rejects_missing_token(self, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_auth_rejects_wrong_key(self, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_auth_accepts_correct_key(self, monkeypatch):
        ...
        result = await require_api_key(creds)
